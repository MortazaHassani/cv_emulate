  ...
  \cventry
      ...
      {Apr. 2024 - June 2024} % Date(s)
      {
        \begin{cvitems} % Description(s) of tasks/responsibilities
          ...
          \item \hspace{1em}{Utilized C and Python for SoC definition and configuration.}
          \item \hspace{1em}{Successfully integrated UART, SPI and I2C communication cores on SoC for sniffing purposes.}
          \item \hspace{1em}{Conducted comprehensive security assessments and formulated recommendations for enhancements.}
        \end{cvitems}
      }
  ...
  \cventry
    ...
    {Apr. 2022 - Aug. 2023} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item \hspace{1em}{Utilized SystemVerilog for testbench creation for the verification of designs.}
  ...
  \cventry
    ...
    {July 2021 - Oct. 2021} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item \hspace{1em}{Developed an industrial object detection algorithm incorporating volumetric calculations to enhance spatial analysis and efficiency. Integrated the algorithm into a courier company's workflow.}
        \item \hspace{1em}{Conducted extensive testing and validation to ensure robust performance in various environments.}
      \end{cvitems}
    }
